...
= 2.2.6 =
* Switched Google fonts source from the Google Fonts CDN to font files included in the theme folder.

= 2.2.5 =
* Changed default thumbnail images.
* Changed widget area width of the new block widget area editor.
* Removed google plus icon since it is no longer available.
* Added block styles for the search block.
