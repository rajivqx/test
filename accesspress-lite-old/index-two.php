...
<h1><?php _e('Specialized In','accesspresslite') ?></h1>
<?php 
...
<section id="bottom-section">
	<div class="ak-container">
        ...
        <aside id="text-3" class="widget widget_text">
            <h3 class="widget-title"><?php _e('Why Us?','accesspresslite'); ?></h3>
            <div class="textwidget">
            <?php _e('Our rapid growth is attributed to our ability to provide small to medium enterprises with ‘one-stop’, online marketing campaigns based on custom-built, responsive websites and incorporating secure high speed hosting, social media and search engine marketing. <br />
                .','accesspresslite');?>
